...
The Unraid template uses `/data` inside the container for generated datasets, vocab files, and model checkpoints, so image updates do not erase training outputs.
